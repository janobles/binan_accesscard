...
<?= view('components/toolbar', [
    ...
    'actionsHtml' => $canManage ? '<button class="' . btn('add') . ' flex-fill js-service-modal-open" type="button" data-service-mode="create"><i class="bi bi-plus-lg me-1" aria-hidden="true"></i>Add Service</button>' : '',
    'filterGroups' => [[
        'name' => 'status',
        'label' => 'Status',
        'options' => [
