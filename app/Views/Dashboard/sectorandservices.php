	...
	<div class="row g-3 mb-3">
		<div class="col-md-4 col-lg-3">
			...
			<div class="border rounded p-2 bg-white" id="sectorCategoryList" role="group" aria-label="Sector categories" data-sector-catalog="<?= esc($sectorCatalogJson, 'attr') ?>">
				...
				<label class="form-check mb-0">
					<input class="form-check-input" type="checkbox" name="sector_categories[]" value="OTHER" <?= in_array('OTHER', $selectedSectorCategories, true) ? 'checked' : '' ?>>
					<span class="form-check-label">Other Sectors</span>
				</label>
			</div>
		</div>
