 ...
 */
?>
<?php /* Search toolbar lives in sectors.php, above this card (Manage Records standard). */ ?>
	<?php /* Controls row, Manage Records standard: page search left, show-entries right. */ ?>
	<div class="table-meta">
		<div class="records-table-controls">
			<form class="records-table-search-form" role="search" data-lookup-search aria-label="Search shown sectors">
				<div class="input-group input-group-sm">
					<input class="form-control" type="search" id="sectorLocalSearch" data-lookup-search-input placeholder="Search this page..." autocomplete="off" aria-label="Search this page">
